...
namespace ChatReader.Core.Utils
{
    ...
    {
        public static ParsedIRCMessage ParseMessage(string message)
        {
            message = message.TrimEnd();
            var iRCMessage = new ParsedIRCMessage();
        ...
        public static void ParseTags(string tagsString, ref ParsedIRCMessage iRCMessage)
        {
        ...
        public static void ParsePrefix(string prefixString, ref ParsedIRCMessage iRCMessage)
        {
        ...
        public static void ParseCommand(string command, string paramsString, ref ParsedIRCMessage iRCMessage)
        {
            iRCMessage.Command = Enum.TryParse(command, out IRCMessageCommand value) ? value : IRCMessageCommand.INVALID;
